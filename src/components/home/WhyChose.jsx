...
export default function WhyChose(){
    return (
        <div className='whyContainer' style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",gap:"10px",background:"linear-gradient(to bottom,rgb(255, 255, 255),rgb(255, 252, 252))",margin:"70px 0px"}}>
            ...
            <div className="cards" >
                <div className="card whycard" data-aos="fade-up" data-aos-delay="0">
                ...
                <div className="card whycard" data-aos="fade-up" data-aos-delay="150">
                    <div className="iconCard">
                        <UsersRound/>
                    </div>
                ...
                <div className="card whycard" data-aos="fade-up" data-aos-delay="300">
                    <div className="iconCard">
                        <Building2 />
                    </div>
