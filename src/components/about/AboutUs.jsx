...
import { getAboutUsStats } from '../../services/AboutUsService';
...
const AboutUs = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      const res = await getAboutUsStats();
      if (res.success) {
        setStats(res.data);
      } else {
  ...
  const teamMembers = [
    { name: "Oussama Nouhar", role: "Software Engineering", image: img6 },
    { name: "Omaima Saif", role: "Software Engineering", image: img7 },
    { name: "Souhayla Ghanem", role: "Software Engineering", image: img8 },
  ];
    ...
    <div>
      <section className="aboutUs-section" data-aos="fade-up">
        <div className="aboutUs-container">
          ...
          <h1 className="aboutUs-title">Notre mission: Simplifier le logement étudiant</h1>
          <p className="aboutUs-text">
            ColocMeak a été créé pour résoudre les défis du logement étudiant en connectant les étudiants avec des logements abordables et des colocataires compatibles.
          </p>
        </div>
      </section>
      ...
      <div className="Us-our-story" data-aos="fade-right">
        <div className="Us-text">
          ...
          <p className="Us-story-text">
            ColocMeak a été fondé en 2025 par trois anciens étudiants qui ont eux-mêmes connu les difficultés de trouver un logement abordable et des colocataires fiables pendant leurs études.
          </p>
          <p className="Us-story-text">
          ...
          <p className="Us-story-text">
            Aujourd'hui, ColocMeak est présent dans plus de {stats ? stats.cityCount : '...'} villes universitaires et a aidé plus de {stats ? formatNumber(stats.studentCount) : '...'} étudiants à trouver leur logement idéal.
          </p>

          {!stats && <div className="Us-loading">Chargement des statistiques...</div>}

          {stats && (
            <div className="Us-features">
              <div><CheckCircle className="aboutUs-icon" /> <span>{stats.cityCount}+ villes</span></div>
              <div><CheckCircle className="aboutUs-icon" /> <span>{formatNumber(stats.studentCount)}+ étudiants</span></div>
              <div><CheckCircle className="aboutUs-icon" /> <span>{formatNumber(stats.ownerCount)}+ propriétaires</span></div>
            </div>
          )}
        </div>
      ...
      <section className="aboutUs-nos-valeurs-section">
        ...
        <div className="aboutUs-valeurs-grid">
          <div className="aboutUs-valeur-card" data-aos="zoom-in">
            <div className="aboutUs-valeur-icon-wrapper"><Users className="aboutUs-valeur-icon" /></div>
          ...
          <div className="aboutUs-valeur-card" data-aos="zoom-in">
            <div className="aboutUs-valeur-icon-wrapper"><Shield className="aboutUs-valeur-icon" /></div>
          ...
          <div className="aboutUs-valeur-card" data-aos="zoom-in">
            <div className="aboutUs-valeur-icon-wrapper"><Award className="aboutUs-valeur-icon" /></div>
      ...
      <div className="aboutUs-text-centre">
        ...
        <p className="aboutUs-centre-texte">
          ColocMeak est composé d'une équipe passionnée d'anciens étudiants, de développeurs et d'experts en immobilier qui comprennent les défis du logement étudiant.
        </p>
      </div>
        ...
        {stats && (
          <div className="aboutUs-impact-stats">
            <div className="aboutUs-impact-card">
              <div className="aboutUs-impact-number">{formatNumber(stats.studentCount)}+</div>
              <div className="aboutUs-impact-label">Étudiants logés</div>
            </div>
            <div className="aboutUs-impact-card">
              <div className="aboutUs-impact-number">{stats.cityCount}+</div>
              <div className="aboutUs-impact-label">Villes universitaires</div>
            </div>
            <div className="aboutUs-impact-card">
              <div className="aboutUs-impact-number">{formatNumber(stats.colocationCount)}+</div>
          ...
          <div className="aboutUs-testimonial-row">
            <div className="aboutUs-testimonial-card">
              <div className="aboutUs-testimonial-content">
                ...
                <p className="aboutUs-testimonial-text">
                  "Grâce à ColocMeak, j'ai trouvé un appartement abordable à 10 minutes de mon campus et un colocataire avec qui je m'entends parfaitement. Le processus était simple et rapide!"
                </p>
            ...
            <div className="aboutUs-testimonial-card">
              <div className="aboutUs-testimonial-content">
                <div className="aboutUs-testimonial-bar" />
                <p className="aboutUs-testimonial-text">
                  "En tant que propriétaire, ColocMeak m'a permis de trouver des locataires fiables rapidement. La plateforme est intuitive et l'équipe de support est toujours disponible."
                </p>
      ...
      <section className="aboutUs-cta-section">
        <h2 className="aboutUs-cta-title">Rejoignez la communauté ColocMeak</h2>
        <p className="aboutUs-cta-subtitle">
          Que vous soyez étudiant à la recherche d'un logement ou propriétaire souhaitant louer à des étudiants, ColocMeak est là pour vous.
        </p>
